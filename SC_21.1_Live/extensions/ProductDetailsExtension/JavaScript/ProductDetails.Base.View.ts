...
import locationQut = require('../../LocationQuntatity/JavaScript/LocationQuntatity.View');
...
const ProductDetailsBaseView: any = BackboneView.extend(
    {
        ...
        childViews: {
            ...
            'LocationQut': function() {
                return new locationQut({
                    model: this.model
                });
            },
            Quantity: function() {
        ...
        getContext: function() {
            ...
            // const quantity = this.model.get('quantityavailable_detail');
            ...
            return {
                ...
                // location
                location :item_model.get('location'),
                //quantityavailable 
                quantityavailable:item_model.get('quantityavailable'),
